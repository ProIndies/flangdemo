...
class Config {
  ...
  /// Generated by SiteNative 30-06-2022 16:22:46
  /// App UID: c0b7e2d7-a054-6bf3-4cd5-665181665f18
  /// Version: https://theyardvilla.combackend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "JBBN";
  // App link
  static String appLink = "https://proindies.com";
  ...
  // Admin email
  static String appEmail = "yardvilla@gmail.com";
  // Template
  ...
  // Signing
  static String osSigning = "7aff668e8870d489c825275d5b33e6f5cf8056615a6c47480875b7534627e3a7";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Call Us",icon: "call-outline.svg",type: ActionType.phone,value: "9664305874",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "Call",icon: "call.svg",type: ActionType.phone,value: "9664305874",),
